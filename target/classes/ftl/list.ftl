                ...
                <div class="col-xs-12">
                    ...
                    <div class="clearfix">
                        <div class="pull-left tableTools-container-left">
                            <div class="btn-group">
                                <a type="button" class="btn btn-info" th:href="@{/${modelName?lower_case}/add}" sec:authorize="hasAuthority('${modelName?lower_case}:add')">创建</a>
...
<#list cols?keys as key>
            ...
            new $.fn.dataTable.Buttons(myTable, {
                buttons: [
                    {
                        "extend": "colvis",
                        "text": "<i class='fa fa-filter bigger-110 blue'></i> <span class='hidden'>显示/隐藏 列</span>",
