define({ "api": [
  ...
  {
    "type": "post",
    "url": "localhost:8080/device/exist",
    "title": "设备生产编号重复验证",
    "name": "deviceExist",
    "group": "device",
    "parameter": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>需要验证的字段名（device_production_num）</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "examples": [
      {
        "title": "Request-Example:",
        "content": "localhost:8080/device/exist?name=device_production_num&value=00012",
        "type": "json"
      }
    ],
    "version": "0.0.0",
  ...
  {
    "type": "post",
    "url": "localhost:8080/intermediary/exist",
    "title": "中间商名称验证",
    "name": "exist",
    "group": "intermediary",
    "parameter": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>需要验证的字段名（intermediary_name）</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "examples": [
      {
        "title": "Request-Example:",
        "content": "localhost:8080/intermediary/exist?name=intermediary_name&value=中间商4",
        "type": "json"
      }
    ],
    "version": "0.0.0",
